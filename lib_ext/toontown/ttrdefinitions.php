...
class TTRDefinitions extends TTGenericDefinitions
{
	...
	public function getFishDict()
	{
		...
		return array(
			...
			0 => array(
				array('', 1,3,1,array($pg_FunnyFarm, $pg_anywhere)),
			...
			4 => array(
				...
				array('', 2,8,6,array($pg_ToontownCentral, $pg_MinniesMelodyland, $pg_OutdoorZone))
			),
			6 => array(
			...
			10 => array(
				array('', 6,10,9,array($pg_Estate, $pg_FunnyFarm, $pg_OutdoorZone, $pg_anywhere)),
			),
			12 => array(
				array('', 7,15,1,array($pg_DonaldsDock, $pg_OutdoorZone, $pg_anywhere)),
				array('', 18,20,6,array($pg_DonaldsDock, $pg_Estate, $pg_OutdoorZone)),
				array('', 1,5,5,array($pg_DonaldsDock, $pg_Estate)),
				array('', 3,7,4,array($pg_DonaldsDock, $pg_Estate)),
				array('', 1,2,2,array($pg_DonaldsDock, $pg_OutdoorZone, $pg_anywhere))
			),
			14 => array(
			...
			16 => array(
				array('', 4,12,5,array($pg_MinniesMelodyland, $pg_OutdoorZone, $pg_anywhere)),
				array('', 4,12,7,array($pg_BaritoneBoulevard, $pg_MinniesMelodyland)),
				array('', 4,12,8,array($pg_TenorTerrace, $pg_MinniesMelodyland, $pg_OutdoorZone))
			),
			18 => array(
			...
			24 => array(
				...
				array('', 8,12,5,array($pg_DaisyGardens, $pg_DonaldsDock, $pg_OutdoorZone)),
				array('', 8,12,6,array($pg_DaisyGardens, $pg_DonaldsDock)),
				array('', 8,16,7,array($pg_DaisyGardens, $pg_DonaldsDock))
			),
			26 => array(
				array('', 10,18,2,array($pg_TheBrrrgh, $pg_FunnyFarm, $pg_OutdoorZone)),
				array('', 10,18,3,array($pg_TheBrrrgh)),
				array('', 10,18,4,array($pg_TheBrrrgh)),
				array('', 10,18,5,array($pg_TheBrrrgh, $pg_FunnyFarm, $pg_OutdoorZone)),
				array('', 12,20,6,array($pg_TheBrrrgh, $pg_FunnyFarm)),
				array('', 14,20,7,array($pg_TheBrrrgh)),
				array('', 14,20,8,array($pg_SleetStreet, $pg_FunnyFarm, $pg_TheBrrrgh)),
				array('', 16,20,10,array($pg_WalrusWay, $pg_TheBrrrgh, $pg_OutdoorZone))
			),
			28 => array(
			...
			32 => array(
				...
				array('', 1,5,5,array($pg_DonaldsDreamland, $pg_Estate, $pg_OutdoorZone)),
